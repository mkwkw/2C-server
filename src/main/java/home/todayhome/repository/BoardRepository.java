...
public interface BoardRepository extends JpaRepository<Board, Integer> {
    ...
    @Query("SELECT new home.todayhome.dto.BoardDto(b.id, u.nickname, b.title, b.content, count(c), b.heartCount, b.visitorCount, b.createdAt) " +
            "FROM Board b " +
            "INNER JOIN User u on u = b.user " +
            "INNER JOIN Comment c on b.id = c.board.id " +
            "group by b.id "
    )
